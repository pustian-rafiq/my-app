                        ...
                        <Container className="text-center">
                            <Row>
                                <Col lg={8} md={6} sm={12}>
                                    <Row className="countSection">
                                        <Col>
                                            ...
                                            <h4 className="countTitle">Total Porjects</h4>
                                ...
                                <Card className="workCard">
                                    ...
                                    <Card.Body>
                                        <Card.Title className="cardTitle text-justify">How i wokrs</Card.Title>
                                        <Card.Text>
                                            <p className="cardSUbTitle text-justify"><FontAwesomeIcon className="iconBullet" icon={faCheckCircle} /> Requirements Gathering</p>
